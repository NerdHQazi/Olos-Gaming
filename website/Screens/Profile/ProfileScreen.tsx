...
export default function ProfileScreen() {
  ...
  return (
    <div className="min-h-screen bg-[#050B18] text-white selection:bg-olos-blue/30 overflow-x-hidden">
      ...
      <main className="pb-20 px-4 md:px-8 max-w-[1200px] mx-auto animate-fade-in">
        {/* Profile Header */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-12">
          ...
          <button
            className="px-10 py-3.5 rounded-xl bg-[#3B82F6] hover:bg-[#2563EB] text-white text-[13px] font-black uppercase tracking-widest transition-all active:scale-[0.98] shadow-lg shadow-blue-500/20"
        ...
        <div className="bg-[#0B1121]/40 border border-white/10 rounded-2xl p-8 mb-8">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              <h2 className="text-sm font-bold uppercase tracking-widest text-[#3B82F6] mb-2">
                Web3 Wallet
              </h2>
          ...
          <StatCard
            ...
            icon={
              ...
              >
                ...
                <path d="m3.34 7 4-4 4 4-4 4Z" />
                <path d="m7.84 14 4-4 4 4-4 4Z" />
                <path d="m14.5 17 4-4 4 4-4 4Z" />
              </svg>
            }
          />
        </div>
        ...
        {/* Performance Section */}
        <div className="bg-[#0B1121]/40 border border-white/10 rounded-2xl p-8 mb-8">
          <h2 className="text-sm font-bold uppercase tracking-widest text-[#3B82F6] mb-8">
            Performance
          </h2>
        ...
        <div className="bg-[#0B1121]/40 border border-white/10 rounded-2xl p-8">
          <h2 className="text-sm font-bold uppercase tracking-widest text-white/50 mb-12">
            Match History
          </h2>
