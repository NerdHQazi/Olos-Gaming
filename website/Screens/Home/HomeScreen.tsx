    ...
    <div className="min-h-screen bg-[#02040A] text-white selection:bg-olos-blue/30 overflow-x-hidden">
        ...
        <div className="relative z-10 w-full h-full flex gap-10 items-center justify-between -translate-y-8 max-xl:flex-col max-xl:translate-y-0 max-xl:gap-8">
          ...
          <div className="flex flex-col gap-7 items-start text-left z-10 animate-fade-in order-2 lg:order-1 lg:max-w-110 lg:max-h-140 -mt-16 max-xl:mt-0 max-xl:w-full max-xl:items-center max-xl:text-center max-xl:max-w-full! max-xl:max-h-none!">
            <div className="flex gap-2 items-center border px-3 py-2 rounded-2xl border-[#7034D7]/80">
              ...
              <h3 className="text-[11px] inter-bold">
                SECURE CRYPTO ESPORTS PLATFORM
              </h3>
            </div>

            <p className="text-[62px] inter-bold leading-16 max-xl:text-[48px] max-xl:leading-[1.15] max-md:text-[38px] max-sm:text-[32px]">
              Play Skill <span className="text-[#00D3FE]">Games.</span> Stake
              Tokens. <span className="text-[#FFB800]">Win On Chain.</span>
            </p>

            <p className="text-[16px] pr-12 leading-7 text-[#A4B7EB] max-xl:pr-0 max-sm:text-[15px]">
              Compete in lightning-fast, skill-based mini-games. Stake GVT
              tokens and battle head-to-head. Zero randomness, pure competition,
              settled instantly by audited smart contracts.
            </p>
          ...
          <div className="flex flex-col items-start text-left z-10 animate-fade-in order-2 lg:order-1 lg:min-w-150 -mt-16 max-xl:mt-0 max-xl:min-w-0! max-xl:w-full max-xl:items-center">
            <Image
              ...
              width={750}
              height={500}
              className="max-xl:w-full max-xl:h-auto max-xl:max-w-187.5"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-28 flex flex-col gap-6 items-center inter-bold max-md:py-16">
        <div className="flex flex-col items-center gap-2 max-xl:px-8 max-xl:text-center max-md:px-5">
          ...
          <h3 className="text-[38px] max-md:text-[26px] max-md:leading-tight">
            Battle On-Chain, Claim The Pot
          </h3>
          <p className="text-[15px] text-[#A4B7EB] inter-extralight">
            High-fidelity game environments engineered for absolute fairness. No
            luck, no algorithms. Just pure skill.
          </p>
        </div>
      ...
      <section className="relative z-10 p-24 bg-[#060A16] inter-bold flex flex-col gap-10 items-center max-xl:p-8 max-md:px-5 max-md:py-16">
        <div className="flex flex-col items-center gap-2 max-xl:text-center">
          ...
          <h3 className="text-[38px] max-md:text-[26px] max-md:leading-tight">
            Four Steps to Absolute Victory
          </h3>
          <p className="text-[15px] text-[#A4B7EB] inter-extralight">
            Connecting developers, gamers, and stakeholders on a trustless
            execution protocol.
          </p>
        </div>
        <div className="flex items-center justify-between w-full gap-10 max-xl:grid max-xl:grid-cols-2 max-xl:items-stretch max-xl:gap-6 max-sm:grid-cols-1">
          <div className="flex flex-col bg-[#0B0F19] py-8 px-5 border border-foreground/10 rounded-2xl  w-full gap-3 min-h-4">
            ...
            <p className="text-[#A4B7EB] pr-8 inter-extralight text-[13px] ">
              Link MetaMask, Coinbase, or any EVM wallet. Your keys control your
              identity.
            </p>
          </div>
          <div className="flex flex-col bg-[#0B0F19] py-8 px-5 border border-foreground/10 rounded-2xl  w-full gap-3 min-h-4">
            ...
            <p className="text-[#A4B7EB] pr-8 inter-extralight text-[13px] ">
              Choose from 1v1 arenas, tournaments, or high-score sprints.
            </p>
          </div>
          <div className="flex flex-col bg-[#0B0F19] py-8 px-5 border border-foreground/10 rounded-2xl  w-full gap-3 min-h-4">
            <div className="flex items-center justify-between">
            ...
            <p className="text-[#A4B7EB] pr-8 inter-extralight text-[13px] ">
              Lock equal token values in secure escrow smart contracts.
            </p>
          </div>
          <div className="flex flex-col bg-[#0B0F19] py-8 px-5 border border-foreground/10 rounded-2xl  w-full gap-3 min-h-4">
            <div className="flex items-center justify-between">
            ...
            <p className="text-[#A4B7EB] pr-8 inter-extralight text-[13px] ">
              Secure victory and receive instant token payouts to your address.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="p-24 flex items-center inter-bold justify-between max-xl:flex-col max-xl:items-stretch max-xl:gap-10 max-xl:p-8 max-md:px-5 max-md:py-16">
        <div className="max-xl:w-full">
          <div className="flex flex-col gap-1.5">
            ...
            <h3 className="text-[38px] max-md:text-[26px] max-md:leading-tight">
              Your Rank Lives Forever
            </h3>
            <p className="text-[15px] text-[#A4B7EB] inter-extralight">
              Our database is the blockchain. Climb the global rankings, claim
              top spot <br className="max-xl:hidden" /> rewards, and build a
              permanent Web3 gaming identity.
            </p>
          </div>
          <Link
            href="/leaderboard"
        ...
        <div className="min-w-160 p-10 bg-[#0B0F19] border border-foreground/10 rounded-2xl flex flex-col gap-2 max-xl:min-w-0 max-xl:w-full max-md:p-5">
          <div className="flex items-center justify-between pb-3 border-b border-foreground/10 max-sm:flex-wrap max-sm:gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-[11px] text-[#00FF87] inter-extralight">
                LIVE UPDATE
              </h3>
            </div>
          </div>
      ...
      <section className="p-24 bg-[#060A16] flex items-center inter-bold justify-between gap-20 max-xl:flex-col max-xl:items-stretch max-xl:gap-10 max-xl:p-8 max-md:px-5 max-md:py-16">
        <div className="min-w-160 p-10 bg-[#0B0F19] border border-foreground/10 rounded-2xl flex flex-col gap-5 max-xl:min-w-0 max-xl:w-full max-md:p-5">
          ...
          <h3 className="inter-extralight text-[#A4B7EB] text-[11px]">
            SELECT ENTRY AMOUNT (GVT)
          </h3>
          <div className="flex items-center gap-2 text-[13px] max-sm:flex-wrap">
            <button
              onClick={() => setStakeAmount(10)}
              className={`${stakeAmount === 10 ? "bg-[#00D3FE1F] text-[#00D3FE] border-[#00D3FE] border-2" : "bg-transparent border-foreground/10"} px-3 py-1.5 border  cursor-pointer rounded-lg`}
            >
              10
            </button>
            <button
              onClick={() => setStakeAmount(25)}
              className={`${stakeAmount === 25 ? "bg-[#00D3FE1F] text-[#00D3FE] border-[#00D3FE] border-2" : "bg-transparent border-foreground/10"} px-3 py-1.5 border  cursor-pointer rounded-lg`}
            >
              25
            </button>
            <button
              onClick={() => setStakeAmount(50)}
              className={`${stakeAmount === 50 ? "bg-[#00D3FE1F] text-[#00D3FE] border-[#00D3FE] border-2" : "bg-transparent border-foreground/10"} px-3 py-1.5 border cursor-pointer rounded-lg`}
            >
              50
            </button>
            <button
              onClick={() => setStakeAmount(100)}
              className={`${stakeAmount === 100 ? "bg-[#00D3FE1F] text-[#00D3FE] border-[#00D3FE] border-2" : "bg-transparent border-foreground/10"} px-3 py-1.5 border cursor-pointer rounded-lg`}
            >
              100
            </button>
            <button
              onClick={() => setStakeAmount(250)}
              className={`${stakeAmount === 250 ? "bg-[#00D3FE1F] text-[#00D3FE] border-[#00D3FE] border-2" : "bg-transparent border-foreground/10"} px-3 py-1.5 border cursor-pointer rounded-lg`}
            >
              250
            </button>
          </div>
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              <h3 className="text-[#A4B7EB] text-[13px] inter-extralight">
                Your locked stake
              </h3>
            ...
            <div className="flex items-center justify-between">
              <h3 className="text-[#A4B7EB] text-[13px] inter-extralight">
                You Win If Victorious
              </h3>
              <h3 className="text-[#00FF87]">
                {stakeAmount * 2 - stakeAmount * 0.1} GVT
              </h3>
            </div>
          </div>
          <Link
            href="/stake"
            className="px-6 py-3 rounded-lg text-[#02040A] bg-[#00D3FE] border border-[#20CEEE80] hover:shadow-lg hover:shadow-[#00D3FE4D] shadow cursor-pointer text-[14px] max-w-30 transition-all active:scale-95 flex items-center gap-4"
          >
            Play Now
          </Link>
        </div>
        <div className="max-xl:w-full">
          <div className="flex flex-col gap-1.5">
            ...
            <h3 className="text-[38px] max-md:text-[26px] max-md:leading-tight">
              Dual-Stake Escrow. Winner Takes All.
            </h3>
            <p className="text-[15px] text-[#A4B7EB] inter-extralight">
              Our smart contracts lock identical deposits from both players.
              Platform takes a 5% Platform Fee. Rest goes instantly to the
              victor.
            </p>
          </div>
          <div className="flex flex-col gap-4 mt-8">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-[#6B7280] text-[13px] inter-extralight">
                  No trust required. Funds are stored programmatically.
                </p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-[#6B7280] text-[13px] inter-extralight">
                  Instantly claim rewards back to your Web3 wallet.
                </p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-[#6B7280] text-[13px] inter-extralight">
                  Advanced match state checking prevents sybil validation
                  attacks.
                </p>
              </div>
            </div>
      ...
      <section className="py-28 flex flex-col gap-6 items-center inter-bold max-md:py-16">
        <div className="flex flex-col items-center gap-2 max-xl:px-8 max-xl:text-center max-md:px-5">
          ...
          <h3 className="text-[38px] max-md:text-[26px] max-md:leading-tight">
            Endorsed by Top Players
          </h3>
          <p className="text-[15px] text-[#A4B7EB] inter-extralight">
            Discover what professional cyber athletes and protocol validators
            are saying about OLOS.
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 px-24 gap-6 mt-6 w-full max-xl:px-8 max-md:px-5 max-md:grid-cols-1!">
          <div className="flex flex-col gap-4 py-7 pl-8 pr-24 bg-[#0B0F19] border border-foreground/10 rounded-2xl max-xl:pr-8 max-md:pl-6 max-md:pr-6">
            ...
            <p className="text-[15px] inter-extralight">
              "The GVT smart contracts are incredibly elegant. 1v1 execution
              settled under 2 seconds. Truly institutional grade."
            </p>
          ...
          <div className="flex flex-col gap-4 py-7 pl-8 pr-24 bg-[#0B0F19] border border-foreground/10 rounded-2xl max-xl:pr-8 max-md:pl-6 max-md:pr-6">
            ...
            <p className="text-[15px] inter-extralight">
              "I've made over 400 GVT in hyper-snake this month. Absolute zero
              lag on my key inputs. A game changer."
            </p>
            <div className="flex items-center gap-4 mt-4">
              <Image
                src="/userUIcon.png"
      ...
      <section className="relative z-10 p-24 bg-[#060A16] inter-bold flex flex-col gap-10 items-center max-xl:p-8 max-md:px-5 max-md:py-16">
        <div className="flex flex-col items-center gap-2 max-xl:text-center">
          ...
          <h3 className="text-[38px] max-md:text-[26px] max-md:leading-tight">
            Built for Real-Time Competitive Gaming
          </h3>
          <p className="text-[15px] text-[#A4B7EB] inter-extralight">
            Technical specs running the engine behind OLOS's zero-trust
            execution system.
          </p>
        </div>
        <div className="flex flex-col items-center w-full gap-3">
          <div className="py-5 px-6 bg-[#0B0F19] border border-foreground/10 rounded-lg flex items-center w-full max-md:flex-col max-md:items-start max-md:gap-2">
            <h3 className="text-[#00D3FE] text-[15px] min-w-80 max-md:min-w-0">
              Latency Tolerance
            </h3>
            <p className="text-[13px] text-[#A4B7EB] inter-extralight">
              Sub-100ms state engine replication between multi-nodes.
            </p>
          </div>
          <div className="py-5 px-6 bg-[#0B0F19] border border-foreground/10 rounded-lg flex items-center w-full max-md:flex-col max-md:items-start max-md:gap-2">
            <h3 className="text-[#00D3FE] text-[15px] min-w-80 max-md:min-w-0">
              Fair Play & Instant Settlement
            </h3>
            <p className="text-[13px] text-[#A4B7EB] inter-extralight">
              Off-chain speed with on-chain payout security.
            </p>
          </div>
          <div className="py-5 px-6 bg-[#0B0F19] border border-foreground/10 rounded-lg flex items-center w-full max-md:flex-col max-md:items-start max-md:gap-2">
            <h3 className="text-[#00D3FE] text-[15px] min-w-80 max-md:min-w-0">
            ...
            <p className="text-[13px] text-[#A4B7EB] inter-extralight">
              Connect with Ethereum, Arbitrum, Base, or Polygon.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-40 text-center flex flex-col items-center gap-10 inter-bold max-md:py-20 max-md:px-5">
        <div className=" border-white/5">
          <h2 className="text-4xl md:text-[42px] font-black mb-4 text-white max-sm:text-[28px]">
            Ready to Prove Your Skills?
          </h2>
          <p className="text-[#A4B7EB] mb-12 text-[15px] inter-extralight">
            No email or registration required. Connect your wallet to stake, or
            practice completely free.
          </p>
      ...
      <footer className="py-24 px-20 bg-[#010101] inter-normal max-xl:px-8 max-md:px-6 max-md:py-14">
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-4 max-lg:gap-10 md:max-lg:grid-cols-2!">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[#A4B7EB] text-[16px] leading-8">
              Web3 skill gaming , Compete,
              <br /> Stake and earn -your reputation <br /> lives on-chain
            </p>
          ...
          <div className="flex flex-col">
            <ul>
              ...
              <li className="mt-2">
                <Link
                  href="/leaderboard"
                  className="text-[15px] text-[#A4B7EB]"
                >
                  Leaderboard
                </Link>
              </li>
        ...
        <div className="w-full flex items-center justify-between mt-10 pr-60 max-xl:pr-0 max-md:flex-col max-md:items-start max-md:gap-3">
          <p className="text-[14px] text-[#A4B7EB]">
            © 2026 OLOS Gaming Platform. All rights reserved
          </p>
          <p className="text-[14px] text-[#A4B7EB]">
            Powered by GVT Token · EVM Smart Contracts
          </p>
        </div>
      </footer>
    </div>
  ...
  return (
    <div className="flex items-center justify-between w-full max-sm:gap-2">
      <div className="flex items-center gap-4 max-sm:gap-2">
        <h3 style={{ color: color }} className="text-[15px]">
          #{Ranking}
        </h3>
        <div className="flex items-center">
          <Image
            ...
            width={44}
            height={54}
            className="rounded-full max-sm:shrink-0 max-sm:w-9 max-sm:h-auto"
          />
      ...
      <h3 className="text-[#FFB800] max-sm:text-[13px] max-sm:shrink-0">
        {userPoints} GVT
      </h3>
    </div>
  );
    ...
    <div className="flex flex-col bg-[#0a0f1e] rounded-3xl border border-blue-500/10 overflow-hidden group hover:border-blue-500/30 transition-all hover:-translate-y-1">
      <div className="aspect-[1.4] overflow-hidden">
        <img
          src={image}
          alt={title}
          className="w-full h-full object-cover transition-all border-[#A4B7EB] border-l-2 border-2 duration-300"
        />
      ...
      <div className="p-6 flex-1 flex flex-col gap-3">
        ...
        <p className="text-[#A4B7EB] text-xs inter-extralight leading-relaxed mb-6 line-clamp-2 flex-1">
          {description}
        </p>
        <div className="w-full h-0.5 border border-foreground/10"></div>
        <div className="flex justify-between items-center">
          <div className="flex flex-col">
            <h3 className="text-[9px] text-[#6B7280] uppercase inter-extralight">
              Min Stake
            </h3>
          ...
          <div className="flex flex-col">
            ...
            <h3 className="text-[14px]" style={{ color }}>
              {volatility}
            </h3>
          </div>
        </div>
        <Link
          href="/games"
          className="px-5 py-3 rounded-lg text-[11px] text-[#02040A] uppercase transition-all cursor-pointer"
