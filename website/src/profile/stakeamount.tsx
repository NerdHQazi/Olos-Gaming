...
export default function StakeAmount() {
  ...
  const stakeOptions = [
    { amount: 10, usd: "$1.00" },
    { amount: 25, usd: "$2.50" },
    { amount: 50, usd: "$5.00", popular: true },
                  ...
                  <button
                    ...
                    className={`relative p-3.5 rounded-xl border flex flex-col items-center justify-center transition ${
                      selectedStake === opt.amount && !customStake
                        ...
                        : "bg-[#0d1222] border-slate-800/80 text-slate-400 hover:border-slate-700"
                    }`}
                  >
                    {opt.popular && (
                      <span className="absolute -top-2 bg-purple-600 text-[9px] font-extrabold px-1.5 py-0.5 rounded uppercase text-white">
                        Popular
                      </span>
                    )}
