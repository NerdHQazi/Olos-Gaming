...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setApiError(
        extractApiError(err, "Couldn't create your account. Please try again."),
      );
    } finally {
      setLoading(false);
    }
        ...
        <div className="min-h-full w-full max-w-[1300px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0 items-center px-4 sm:px-8 py-6">
          ...
          <div className="hidden lg:flex flex-col justify-center pr-10 xl:pr-16">
            ...
            <p className="text-sm text-gray-400 mt-2 max-w-md">
              Create your account to compete in skill-based games, stake GVT,
              and earn real on-chain rewards.
            </p>
          </div>
              ...
              <div className="space-y-3.5">
                ...
                <label className="flex items-start gap-3 cursor-pointer select-none">
                  ...
                  <span className="text-sm text-gray-300">
                    I agree to the{" "}
                    <Link href="/terms" className="text-[#7135DB]">
                      Terms of Service
                    </Link>{" "}
                    and{" "}
                    <Link href="/privacy" className="text-[#7135DB]">
                      Privacy Policy
                    </Link>
                  </span>
                </label>
