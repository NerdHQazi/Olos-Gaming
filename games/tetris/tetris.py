# Have a way to track broken lines and use that to influence score modifiers and level modifiers...
import pygame
import random
...
class Tetris:
    def __init__(self, height, width):
        ...
        self.height = height # take the height from the initialization and make it a variable for the game field
        self.width = width
        self.zoom = 20
        self.figure = None
        self.x = 100
        self.y = 60
        self.broken_lines = 0 # initial number of broken lines
